# 11.Implement a function named generateRange(min, max, step), which takes three arguments and
...
# generate_range(2, 10, 2) # should re
# list of [2,4,6,8,10]
...
# def sum():
#     start=int(input("enter the where you start"))
#     stop=int(input("enter the where you stop" ))
#     diff=int(input("enter the differace"))
#     a=[]
#     for i in range(start, stop, diff):
#         a.append(i)
#     print(a)
# sum()     
